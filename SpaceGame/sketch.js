...
function preload() {
  ...
  vImage = loadImage('assets/vaisseau3.png');
  bgImage = loadImage('assets/space2.png');
  leaderImage = loadImage('assets/vaisseau2-leader.png');
  missileImage = loadImage('assets/missile2.png');
  obstacleImage = loadImage('assets/lune-cratere.png');
}
...
function setup() {
  ...
  creerUnSlider("Rayon des vaisseaux", vehicles, 30, 100, 6, 1, 10, posYSliderDeDepart,"r");
  creerUnSlider("Poids boundaries", vehicles, 0, 15, 10, 1, 10, posYSliderDeDepart+30,"boundariesWeight");

  //obstacle au milieu de l'ecran
  obstacles.push(new Obstacle(width / 2, height / 2, 100, 'assets/lune-cratere.png'));
...
function draw() {
  ...
  instructions.forEach((text1, index) => {
    text(text1, 10, height - 20 * (instructions.length - index));
  });
...
function mousePressed() {
  ...
  obstacles.push(new Obstacle(mouseX, mouseY, random(50, 100), 'assets/lune-cratere.png'));
}
